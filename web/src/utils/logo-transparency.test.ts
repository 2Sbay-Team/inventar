...
// v0.5.4 ADR-028 — unit tests for the keying math + threshold gate.
// Integration coverage (the full analyseLogoForKeying call + blob
// round-trip + UI confirm flow) lives in the e2e specs 70-74. These
...
// covered by the E2E specs (70-74) where a real DOM + ImageBitmap +
