...
//
// Accepts the v1 OR v2 rows tree (shape-agnostic by design — the hash sees
// only the canonical JSON output, never the TypeScript type).
export async function integrityHash(rows: unknown): Promise<string> {
